...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 67 "parser.mly"
    ( Bool(_1, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 438 "parser.ml"
               : 'simple_exp))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 69 "parser.mly"
    ( Int(_1, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 445 "parser.ml"
               : 'simple_exp))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 71 "parser.mly"
    ( Float(_1, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 452 "parser.ml"
               : 'simple_exp))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 73 "parser.mly"
    ( Var(_1, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 459 "parser.ml"
               : 'simple_exp))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 75 "parser.mly"
    ( Get(_1, _4, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 467 "parser.ml"
               : 'simple_exp))
; (fun __caml_parser_env ->
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 82 "parser.mly"
    ( Not(_2, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 481 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : Syntax.t) in
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 89 "parser.mly"
    ( Add(_1, _3, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 498 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : Syntax.t) in
    ...
    Obj.repr(
# 91 "parser.mly"
    ( Sub(_1, _3, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 506 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : Syntax.t) in
    ...
    Obj.repr(
# 93 "parser.mly"
    ( Eq(_1, _3, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 514 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : Syntax.t) in
    ...
    Obj.repr(
# 95 "parser.mly"
    ( Not(Eq(_1, _3, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)), ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 522 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : Syntax.t) in
    ...
    Obj.repr(
# 97 "parser.mly"
    ( Not(LE(_3, _1, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)), ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 530 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : Syntax.t) in
    ...
    Obj.repr(
# 99 "parser.mly"
    ( Not(LE(_1, _3, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)), ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 538 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : Syntax.t) in
    ...
    Obj.repr(
# 101 "parser.mly"
    ( LE(_1, _3, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 546 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : Syntax.t) in
    ...
    Obj.repr(
# 103 "parser.mly"
    ( LE(_3, _1, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 554 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 106 "parser.mly"
    ( If(_2, _4, _6, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 563 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : Syntax.t) in
    Obj.repr(
# 109 "parser.mly"
    ( FNeg(_2, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 570 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : Syntax.t) in
    ...
    Obj.repr(
# 111 "parser.mly"
    ( FAdd(_1, _3, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 578 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : Syntax.t) in
    ...
    Obj.repr(
# 113 "parser.mly"
    ( FSub(_1, _3, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 586 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : Syntax.t) in
    ...
    Obj.repr(
# 115 "parser.mly"
    ( FMul(_1, _3, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 594 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : Syntax.t) in
    ...
    Obj.repr(
# 117 "parser.mly"
    ( FDiv(_1, _3, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 602 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 120 "parser.mly"
    ( Let(addtyp _2, _4, _6, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 611 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 123 "parser.mly"
    ( LetRec(_3, _5, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 619 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 126 "parser.mly"
    ( App(_1, _2, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 627 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 129 "parser.mly"
    ( Tuple(_1, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 634 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 131 "parser.mly"
    ( LetTuple(_3, _6, _8, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 643 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 133 "parser.mly"
    ( Put(_1, _4, _7, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 652 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : Syntax.t) in
    ...
    Obj.repr(
# 135 "parser.mly"
    ( Let((Id.gentmp Type.Unit, Type.Unit), _1, _3, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 660 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 138 "parser.mly"
    ( Array(_2, _3, ((Parsing.symbol_start_pos ()).pos_lnum,(Parsing.symbol_end_pos ()).pos_lnum)) )
# 668 "parser.ml"
               : Syntax.t))
; (fun __caml_parser_env ->
    Obj.repr(
