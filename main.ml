...
let lexbuf outchan l = (* ???????????ï¿½ï¿½????ï¿½ï¿½?ï¿½ï¿½????ï¿½ï¿½?????????????ï¿½ï¿½?ï¿½ï¿½???????ï¿½ï¿½?ï¿½ï¿½???????? (caml2html: main_lexbuf) *)
  Id.counter := 0;
...
let lexbuf_verbose outchan outchanr outchans outchanv outchanc outchani outchana outchank outchant outchanp l = (* ???????????ï¿½ï¿½????ï¿½ï¿½?ï¿½ï¿½????ï¿½ï¿½?????????????ï¿½ï¿½?ï¿½ï¿½???????ï¿½ï¿½?ï¿½ï¿½???????? (caml2html: main_lexbuf) *)
  Id.counter := 0;
  Typing.extenv := M.empty;
  Emit.f outchan
    (let r = RegAlloc.f
...
let string s = lexbuf_verbose stdout stdout stdout stdout stdout stdout stdout stdout stdout stdout (Lexing.from_string s) (* ???ï¿???????????ï¿½ï¿½?ï¿½ï¿½????ï¿½ï¿½????????ï¿???ï¿?????ï¿½ï¿½?????ï¿???ç¤ºï¿½????? (caml2html: main_string) *)

let file f output_flag = (* ?????ï¿½ï¿½?ï¿½ï¿½???????ï¿½ï¿½?ï¿½ï¿½????ï¿½ï¿½?????????????ï¿½ï¿½?ï¿½ï¿½???????ï¿½ï¿½???????? (caml2html: main_file) *)
(* 

    Args
        f : string
          ??ï¿½ï¿½?ï¿½ï¿½????ï¿½ï¿½?????????????ï¿½ï¿½?ï¿½ï¿½???????????(??ï¿½å¼µï¿???ï¿???ï¿???)
...
let () = (* ??????????????ï¿½ï¿½?ï¿½ï¿½????ï¿½ï¿½?????ï¿???ï¿?????????ï¿???????????? (caml2html: main_entry) *)
  let files = ref [] in
